...
\begin{figure}
    \centering
    \subfigure[Tracks]{\includegraphics[width=.49\textwidth]{figures/matt/shelf_backonly.png}}
...
\begin{figure}
    \centering
    \subfigure[Tracks]{\includegraphics[width=.49\textwidth]{figures/matt/shelf_forwardonly.png}}
